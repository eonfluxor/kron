...
Pod::Spec.new do |s|
  ...
  s.author             = { "Eonflux - Hassan  Uriostegui" => "eonflux@gmail.com" }
  # Or just: s.author    = "eonflux"
  # s.authors            = { "eonflux" => "eonflux@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/eonfluxor/kron.git", :tag => "v#{s.version}" }
